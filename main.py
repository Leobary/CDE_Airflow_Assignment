...
with DAG(
    ...
    template_searchpath="/opt/airflow/dags/coreSentiment/src/",
) as dag:
    ...
    def _download_data():
        url = "https://dumps.wikimedia.org/other/pageviews/2024/2024-10/pageviews-20241010-170000.gz"
        output_dir = "/opt/airflow/dags/coreSentiment/src/pageviews.gz"
    ...
    unzip_data = BashOperator(
        ...
        bash_command="gunzip -f /opt/airflow/dags/coreSentiment/src/pageviews.gz",
    )
    ...
    def _fetch_data(companies):
        ...
        with open(f"/opt/airflow/dags/coreSentiment/src/pageviews", "r") as file:      
            #for row in file:
        ...
        with open(f"/opt/airflow/dags/coreSentiment/src/insert_script.sql", "w") as script:
